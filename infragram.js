...
createScatterBuffer = function(ctx) {
  var index, itemSize, scatterData, x, xInc, y, yInc, _i, _ref;
  itemSize = 2;
  scatterData = [];
  ...
  x = 0.0;
  y = 0.0;
  for (index = _i = 0, _ref = (ctx.canvas.height * ctx.canvas.width * itemSize) - itemSize; itemSize > 0 ? _i <= _ref : _i >= _ref; index = _i += itemSize) {
    scatterData[index] = x;
